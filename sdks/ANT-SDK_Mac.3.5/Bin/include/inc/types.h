...
#define DSI_TYPES_H
   ...
   // Apple antz_platform (first two defines are for Mac OS 9; last two are for Mac OS X)
   #define DSI_TYPES_MACINTOSH
#elif defined(linux) || defined (__linux)                   // Linux antz_platform
...
typedef unsigned short                 USHORT;              // Unsigned 2-byte int.
   ...
   // intended to be cross-antz_platform.
   typedef long                           LONG;
