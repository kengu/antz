...
#define EVENT_QUE_OVERFLOW                         ((UCHAR)0x35)           // ANT event que has overflowed and lost 1 or more event
...
// Internal only event below this point
...
#define EVENT_PASS_THRU                            ((UCHAR)0x82)           // INTERNAL: Event to allow an upper stack event to pass through lower stacks
...
/////////////////////////////////////// ///////
//NOTE: These event are not generated by the embedded ANT module
