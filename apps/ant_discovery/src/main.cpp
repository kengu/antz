...
// The DiscoveryMachine entry point that will replace this one lives in
// main_new.cpp. A commented-out copy used to sit here; it was identical, and
// two copies of an unbuilt main is one too many. See CMakeLists.txt for which
// files belong to that architecture and why they are not compiled yet.
